...
public class Avfile extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Avfile\",\"namespace\":\"file.avro\",\"fields\":[{\"name\":\"filename\",\"type\":\"string\"},{\"name\":\"filecontent\",\"type\":\"bytes\"},{\"name\":\"checksum\",\"type\":\"string\"}]}");
   ...
   */
  public Avfile(java.lang.CharSequence filename, java.nio.ByteBuffer filecontent, java.lang.CharSequence checksum) {
  ...
  /** Creates a new Avfile RecordBuilder */
  public static file.avro.Avfile.Builder newBuilder() {
    return new file.avro.Avfile.Builder();
  }
  
  /** Creates a new Avfile RecordBuilder by copying an existing Builder */
  public static file.avro.Avfile.Builder newBuilder(file.avro.Avfile.Builder other) {
    return new file.avro.Avfile.Builder(other);
  }
  
  /** Creates a new Avfile RecordBuilder by copying an existing Avfile instance */
  public static file.avro.Avfile.Builder newBuilder(file.avro.Avfile other) {
    return new file.avro.Avfile.Builder(other);
  }
  
  /**
   * RecordBuilder for Avfile instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Avfile>
    implements org.apache.avro.data.RecordBuilder<Avfile> {
    ...
    private Builder() {
      super(file.avro.Avfile.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(file.avro.Avfile.Builder other) {
      super(other);
    ...
    /** Creates a Builder by copying an existing Avfile instance */
    private Builder(file.avro.Avfile other) {
            super(file.avro.Avfile.SCHEMA$);
      if (isValidValue(fields()[0], other.filename)) {
        this.filename = data().deepCopy(fields()[0].schema(), other.filename);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'filename' field */
    public file.avro.Avfile.Builder setFilename(java.lang.CharSequence value) {
    ...
    public file.avro.Avfile.Builder clearFilename() {
      filename = null;
    ...
    /** Sets the value of the 'filecontent' field */
    public file.avro.Avfile.Builder setFilecontent(java.nio.ByteBuffer value) {
    ...
    public file.avro.Avfile.Builder clearFilecontent() {
      filecontent = null;
    ...
    /** Sets the value of the 'checksum' field */
    public file.avro.Avfile.Builder setChecksum(java.lang.CharSequence value) {
    ...
    public file.avro.Avfile.Builder clearChecksum() {
      checksum = null;
